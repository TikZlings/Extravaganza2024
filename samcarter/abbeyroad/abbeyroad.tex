...
\setbeamertemplate{background canvas}{\includegraphics[width=\paperwidth]{Abbey_Road_zebra_crossing,_London_2007-03-31}}
...
\begin{frame}
  \begin{tikzpicture}[remember picture, overlay,use page relative coordinates]
    ...
    \ifnum \intmodnn{\thepage}{10} > 5
      \node[anchor=east,xshift=-17cm+\insertoverlaynumber*0.05cm] at (1,0.4) {\includegraphics[height=3cm,page=1]{walking}};
    \else
      \node[anchor=east,xshift=-17cm+\insertoverlaynumber*0.05cm] at (1,0.4) {\includegraphics[height=3cm,page=2]{walking}};
    \fi  
