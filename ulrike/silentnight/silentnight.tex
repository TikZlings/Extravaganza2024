...
\begin{scope}[yshift=-100]
  \path[clip] (47.9231,182.0769) -- (45.0000,179.1539) -- (45.0000,162.5000)
  ...
  \node[] at (100,40){\includegraphics[width=5cm]{tartan3}};
\end{scope}
...
\node[inner sep=0pt]{ 
\includegraphics[width=3cm,page=\numexpr\intmodnn{\value{page}}{6}+1]{bearbagpipe}%
	};
 \begin{scope}[scale=1.5,xshift=0.05cm,yshift=-1.3cm]\bobblehat{xkcdCloudyBlue}{xkcdDullBlue} \end{scope} 

 \begin{scope}[scale=1/\candlescalefactor,xshift=-5.2cm,yshift=-3cm]
\pgfmathsetseed{10} 
%\foreach \n in {1,...,10}{ 
