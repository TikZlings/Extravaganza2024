...
\tagpost[xshift=15.5cm,yshift=-1.5cm]{Formula}
\path (15.5,-3)node[yshift=0.8cm,xshift=-1cm,font=\ttfamily,anchor=south west,fill=white,draw=brown!50!black, rounded corners=1]{\$x=1 \mbox{if }y=-1\$};
