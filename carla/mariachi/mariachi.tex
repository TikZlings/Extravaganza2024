...
\begin{frame}
  ...
  \begin{tikzpicture}[remember picture, overlay,]
    \draw[decorate,
      ...
      with {
        \node[anchor=south, transform canvas={scale=.7+\thepage/\steps}] {\includegraphics[page=1]{funny_marmots}};
        \node[anchor=south,xshift=2cm, transform shape={scale=.7+\thepage/\steps}, transform canvas={scale=.7+\thepage/\steps}] {\includegraphics[page=2]{funny_marmots}};
        \node[anchor=south,xshift=4cm, transform shape={scale=.7+\thepage/\steps}, transform canvas={scale=.7+\thepage/\steps}] {\includegraphics[page=3]{funny_marmots}};
        \node[anchor=south,xshift=6cm, transform shape={scale=.7+\thepage/\steps}, transform canvas={scale=.7+\thepage/\steps}] {\includegraphics[page=4]{funny_marmots}};    
      }}]
